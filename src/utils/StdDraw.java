...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	public static game_service gameGui;
	private DGraph g =new DGraph();
	private game_service game;
	private List<Fruit> fruits;
	private List<Robot_Algo> robots;
	public static StdDraw Mystd;
...
public StdDraw(){
	...
	private StdDraw(game_service n) {
		Game=n;
	}
	...
	public void setStd(StdDraw s){
		this.Mystd=s;
	}
	public void setListRobot(List<Robot_Algo> r){
		this.robots=r;
	}
	public StdDraw (DGraph t,game_service game_service,List<Fruit>fr) {
		this.g=t;
		this.fruits=fr;
		this.game=game_service;
		gg=t;
		gameGui=game_service;
	}
	public StdDraw (List <Robot_Algo> r,DGraph t,game_service game_service,List<Fruit>fr,StdDraw p){
		this.robots=r;
		this.g=t;
		this.fruits=fr;
		this.game=game_service;
...
//			node_data a=this.g.allnode.get(i);
//			System.out.println(a.getKey());
//			StdDraw.show();
//
//			/*if((a.getLocation().x()-x)<= Robot_Algo.EPS1 && a.getLocation().y()-y<=Robot_Algo.EPS1){*/
//				StdDraw.picture(a.getLocation().x(), a.getLocation().y(), "robot.png", 0.0008, 0.0006);
//				StdDraw.picture(x,y,"robot_tec.jpg");
//				StdDraw.show();
//			//}
//		}
//		StdDraw.line(x,x+2,y,y+3);
//

	}
	public static void F_GUI(game_service game , List <Fruit> fruits) {
		fruits.clear();
		enableDoubleBuffering();
		clear();

		enableDoubleBuffering();
		fruits= Fruit.initFromListFruit(game.getFruits());
		for (Fruit f:fruits) {
			if (f.getType() == -1) {
	...
	public static void uptadeGraph(DGraph g){
