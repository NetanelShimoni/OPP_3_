...
/**
 * this class represnt a graph by saving all his details(vertex and edges) in hashmap.
 */
...
//		return a;
	...
	/**
	 * return all the edges that exiting from the vertex
	 * @param node_id
	 * @return
	 */
	@Override
...
//		return a;
	...
	/**
	 * return how many vertex there is in the graph
	 * @return
	 */
	@Override
	public int nodeSize() {
	...
	/**
	 * return how many edges there is in the graph
	 * @return
	 */
	@Override
	public int edgeSize() {
	...
	/**
	 * return how much changes made on the graph
	 * @return
	 */
	@Override
	public int getMC() {
